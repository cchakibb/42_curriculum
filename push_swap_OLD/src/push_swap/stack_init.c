...
static void	append_node(t_stack **stack, int n) //Define a function that searches for the last node to append to the linked list
{
	...
	{
		last_node = get_last_node(*stack); //In which case, find the last node
